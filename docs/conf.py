#!/usr/bin/env python
"""
cantilever documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, "..", "cantilever"))
sys.path.insert(0, src_path)
src_path = os.path.abspath(os.path.join(docs_src_path, ".."))
sys.path.insert(0, src_path)


import cantilever.core  # noqa
...
project = "cantilever"
_full_version = cantilever.core.__version__
author = cantilever.core.__author__
copyright = cantilever.core.__copyright__
...
htmlhelp_basename = "cantilever-doc"
